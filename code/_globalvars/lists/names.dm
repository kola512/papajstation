...
GLOBAL_LIST_INIT(lizard_names_female_last, world.file2list("strings/names/lizard_last_female.txt"))
GLOBAL_LIST_INIT(lizard_names_male_last, world.file2list("strings/names/lizard_last_male.txt"))
